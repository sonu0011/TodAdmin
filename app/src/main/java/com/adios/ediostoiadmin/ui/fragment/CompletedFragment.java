...
public class CompletedFragment extends Fragment {
    ...
    public void onStart() {
        super.onStart();
//        if (methods.getSortedOrders("Completed").size() == 0) {
//            textView.setVisibility(View.VISIBLE);
//        } else {
//            textView.setVisibility(View.INVISIBLE);
//            adapter = new AllOrdersAdapter(methods.getSortedOrders("Completed"), getContext(), Constants.ALL_ORDERS);
                ...
                .enqueue(new Callback<AllOrdersResponse>() {
                    ...
                    public void onResponse(Call<AllOrdersResponse> call, Response<AllOrdersResponse> response) {
                        ...
                        if (response.isSuccessful()) {
                            ArrayList<CustomerOrder> filteredOrders = methods.getSortedOrders( response.body().getResult_Output().getCustomerOrders(),"Completed");
